...
/***/ function(module, exports, __webpack_require__) {
	...
	var _browserHistory = __webpack_require__(240);
	...
	var _summary = __webpack_require__(278);

	var _summary2 = _interopRequireDefault(_summary);

	var _manage_add = __webpack_require__(279);

	var _manage_add2 = _interopRequireDefault(_manage_add);

	var _manage_view = __webpack_require__(282);

	var _manage_view2 = _interopRequireDefault(_manage_view);
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(_Route2.default, { path: '/summary', component: _summary2.default }),
	                        _react2.default.createElement(_Route2.default, { path: '/add(/:type)', component: _manage_add2.default }),
	                        _react2.default.createElement(_Route2.default, { path: '/view', component: _manage_view2.default })
	                    )
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PatternUtils = __webpack_require__(228);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function modal() {
		var state = arguments.length <= 0 || arguments[0] === undefined ? c.INITIAL_STATE : arguments[0];
		var action = arguments[1];
...
/***/ function(module, exports) {
	...
	var MODAL_ON_CHANGE = exports.MODAL_ON_CHANGE = 'MODAL_ON_CHANGE';
	var MODAL_ON_WAITING = exports.MODAL_ON_WAITING = 'MODAL_ON_WAITING';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ModalCollection = __webpack_require__(270);

	var _ModalCollection2 = _interopRequireDefault(_ModalCollection);

	var _BackButton = __webpack_require__(275);
	...
	var Layout = function (_Component) {
	    ...
	    _createClass(Layout, [{
	        key: 'displayBackButton',
	        value: function displayBackButton(page) {
	            if (page != '/') return _react2.default.createElement(_BackButton2.default, { page: page });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_ModalCollection2.default, null),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PropTypes2 = __webpack_require__(252);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Navbar = function Navbar(_ref) {
		...
		var getNavItems = function getNavItems(user) {
			if (user.email != '') {
				return _react2.default.createElement(
					'ul',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ModalWindow = __webpack_require__(272);

	var _ModalWindow2 = _interopRequireDefault(_ModalWindow);

	var _ModalInput = __webpack_require__(273);

	var _ModalInput2 = _interopRequireDefault(_ModalInput);

	var _FinanceRecordCategoryItemInput = __webpack_require__(274);

	var _FinanceRecordCategoryItemInput2 = _interopRequireDefault(_FinanceRecordCategoryItemInput);
	...
	var ModalCollection = function (_Component) {
		_inherits(ModalCollection, _Component);
		...
		function ModalCollection() {
			...
			_classCallCheck(this, ModalCollection);

			for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
				args[_key] = arguments[_key];
			}

			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(ModalCollection)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.handleChange = function (data) {
				_this.props.modalAct.modalOnChange(data);
			}, _this.handleClose = function () {
				_this.props.modalAct.modalHide();
			}, _temp), _possibleConstructorReturn(_this, _ret);
		}

		_createClass(ModalCollection, [{
			key: 'getForm',
			value: function getForm(id) {
				var _props$modal = this.props.modal;
				var properties = _props$modal.properties;
				var data = _props$modal.data;

				switch (id) {
					case 'input':
						return _react2.default.createElement(_ModalInput2.default, {
							name: 'input',
							handleChange: this.handleChange,
							label: properties.inputLabel || "Input Box" });
					case 'financerecordcategoryitem':
						return _react2.default.createElement(_FinanceRecordCategoryItemInput2.default, {
							handleChange: this.handleChange,
							label: properties.inputLabel || "Input Box",
							data: data
						});
	...
	exports.default = (0, _reactRedux.connect)(function (state) {
		...
		return {
			modalAct: (0, _redux.bindActionCreators)(modalActions, dispatch)
		};
	})(ModalCollection);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.modalOnChange = modalOnChange;
	exports.modalOnWaiting = modalOnWaiting;
	...
	function modalOnChange(data) {
		return function (dispatch) {
			return dispatch(onModalOnChange(data));
		};
	}

	function modalOnWaiting(params) {
		return function (dispatch) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ModalWindow = function (_Component) {
		...
		function ModalWindow() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(ModalWindow).apply(this, arguments));
		}
		...
		_createClass(ModalWindow, [{
			...
			value: function render() {
				...
				var properties = modalData.properties || {};

				var show = modalData.show;
				var data = modalData.data;
				var loading = modalData.loading;


				var saveLabel = properties.saveLabel || "Save";

				return _react2.default.createElement(
					"div",
					{ className: "my-modal " + (show ? "" : "hide") },
					_react2.default.createElement(
						"div",
						{ className: "my-modal-window animated zoomIn" },
						_react2.default.createElement(
							"div",
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								loading ? _react2.default.createElement("i", { className: "fa fa-spin fa-spinner" }) : saveLabel
							)
						)
					),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FinanceRecordCategoryItemInput = function FinanceRecordCategoryItemInput(_ref) {
		var handleChange = _ref.handleChange;
		var label = _ref.label;
		var data = _ref.data;
	...
	exports.default = FinanceRecordCategoryItemInput;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SummaryContainer = function (_Component) {
		...
		function SummaryContainer() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(SummaryContainer).apply(this, arguments));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InputItem = __webpack_require__(280);

	var _InputItem2 = _interopRequireDefault(_InputItem);

	var _FinanceRecordCategoryItem = __webpack_require__(281);

	var _FinanceRecordCategoryItem2 = _interopRequireDefault(_FinanceRecordCategoryItem);
	...
	var AddContainer = function (_Component) {
		...
		function AddContainer() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(AddContainer)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
				description: '',
				items: [{
					name: "item 1",
					price: 100000,
				...
				n[e.target.name] = e.target.value;
				_this.setState(n);
			}, _this.handleGetType = function (data) {
				_this.setState({
					type: data,
					page: 'category'
				});
				_history2.default.push('/add/' + data + '?page=category');
			}, _this.handleGetCategory = function (data) {
				_this.setState({
					category: data,
					page: 'details'
				});
				_history2.default.push('/add/' + _this.state.type + '?category=' + data + '&page=details');
			}, _this.handleAddCategory = function (data) {
				_this.props.modalAct.modalShow({
					show: true,
					id: 'input',
					data: {},
					save: _this.saveCategory,
					properties: {
						saveLabel: "Add Category",
						inputLabel: "New category name..."
					}
				});
			}, _this.handleAddItem = function (data) {
				_this.props.modalAct.modalShow({
					show: true,
				...
				var modalAct = _this.props.modalAct;
				...
				setTimeout(function () {
					...
					var newData = _this.state.items.map(function (item, index) {
						if (index != data.id) return item;
						return {
							name: data.name,
							price: data.price,
							note: data.note
					...
					_this.setState({ items: newData });
				}, 2000);
			}, _this.saveCategory = function (data) {
				var modalAct = _this.props.modalAct;
			...
			}, _this.handleFinalize = function (data) {
				...
				_history2.default.push('/add/' + type + '?category=' + category + '&page=summary');
				//console.log("View Summary!", data);
			}, _this.goToType = function () {
				_this.setState({
					page: 'type'
				});
				_history2.default.push('/add?page=type');
			}, _this.goToCategory = function () {
				_this.setState({
					page: 'category'
				});
				_history2.default.push('/add/' + _this.state.type + '?page=category');
			}, _this.goToDetail = function () {
				_this.setState({
					page: 'details'
				});
				var _this$state2 = _this.state;
				var type = _this$state2.type;
				var category = _this$state2.category;

				_history2.default.push('/add/' + type + '?category=' + category + '&page=details');
			}, _temp), _possibleConstructorReturn(_this, _ret);
		}
		...
		_createClass(AddContainer, [{
			...
			value: function componentWillMount() {
				...
				var category = _props$location$query.category;
				var page = _props$location$query.page;
						...
						return _react2.default.createElement(
							...
							_react2.default.createElement(
								...
								this.state.items.map(function (item, index) {
									return _react2.default.createElement(_FinanceRecordCategoryItem2.default, {
										key: index,
										...
										handleEdit: function handleEdit(id) {
											_this2.props.modalAct.modalShow({
												show: true,
												id: 'financerecordcategoryitem',
												data: {
													id: id,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FinanceRecordCategoryItem = function (_Component) {
		_inherits(FinanceRecordCategoryItem, _Component);

		function FinanceRecordCategoryItem() {
			var _Object$getPrototypeO;

			var _temp, _this, _ret;

			_classCallCheck(this, FinanceRecordCategoryItem);

			for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
				args[_key] = arguments[_key];
			}

			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(FinanceRecordCategoryItem)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
				option: false,
				width: 0
			}, _this.handleChangeWindowSize = function () {
				if (_this.canResize) {
				...
				if (_this.state.width > 480) return true;
				if (_this.state.option) return true;
				return false;
			}, _temp), _possibleConstructorReturn(_this, _ret);
		}

		_createClass(FinanceRecordCategoryItem, [{
			key: 'componentWillMount',
			value: function componentWillMount() {
			...
			value: function render() {
				...
				var handleEdit = _props.handleEdit;
				var id = _props.id;
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{
							...
							onClick: function onClick() {
								_this2.setState({ option: _this2.state.option ? false : true });
							} },
						_react2.default.createElement(
							'span',
							{
		...
		return FinanceRecordCategoryItem;
	}(_react.Component);

	exports.default = FinanceRecordCategoryItem;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ViewContainer = function (_Component) {
		...
		function ViewContainer() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(ViewContainer).apply(this, arguments));
		}
